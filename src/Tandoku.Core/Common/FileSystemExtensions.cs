...
public static class FileSystemExtensions
{
    ...
    public static bool ExtensionEquals(this IPath pathObject, string path, string extension) =>
        GetComparer(pathObject).Equals(pathObject.GetExtension(path), extension);
