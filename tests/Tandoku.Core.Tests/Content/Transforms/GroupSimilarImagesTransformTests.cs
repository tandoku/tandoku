...
public class GroupSimilarImagesTransformTests
{
    ...
    public async Task FirstBlockWithImage_NoAnnotation()
    {
        ...
        var transform = GroupSimilarImagesTransform.Create(provider, 0.9, this.VolumeAt("/vol"), this.mockFs);
    ...
    {
        var transform = GroupSimilarImagesTransform.Create(new FakeProvider(), 0.9, this.VolumeAt("/vol"), this.mockFs);
