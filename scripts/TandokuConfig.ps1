param(
    [Parameter()]
    [ValidateSet('azure-computer-vision.apiKey','azure-computer-vision.endpoint','openai.apiKey')] # TODO - get this from some central location (generate from config exported by scripts)
    [String]
    $Key,
